...
public class AuthController {
    ...
    public ResponseEntity<?> revokeToken() {
        ...
        UserDetailCustom currentAccount = (UserDetailCustom) SubUtils.getCurrentUser();
    ...
    public ResponseEntity<?> authenticateGoogleWithJWT(@RequestBody AccountGoogleRequest accountGoogleRequest,
            HttpServletResponse servletResponse) {
    ...
    public ResponseEntity<?> authenticateGithubWithJWT(@RequestBody AccountGithubRequest accountGithubRequest,
            HttpServletResponse servletResponse) {
    ...
    public ResponseEntity<?> authenticateFacebookWithJWT(@RequestBody AccountFacebookRequest accountFacebookRequest,
            HttpServletResponse servletResponse) {
