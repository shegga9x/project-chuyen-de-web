...
import backend.backend.helpers.utils.pdfSignature.algorim.CMSProcessableInputStream;
import backend.backend.helpers.utils.pdfSignature.algorim.SigUtils;
import backend.backend.helpers.utils.pdfSignature.algorim.ValidationTimeStamp;
...
public abstract class CreateSignatureBase implements SignatureInterface {
     ...
     * creation.
     * If you want to create the hash and the signature separately (e.g. to transfer
     * only the hash
     * to an external application), read
     * <a href="https://stackoverflow.com/questions/41767351">this
     * answer</a> or <a href="https://stackoverflow.com/questions/56867465">this
     * answer</a>.
     *
     * @throws IOException
     */
