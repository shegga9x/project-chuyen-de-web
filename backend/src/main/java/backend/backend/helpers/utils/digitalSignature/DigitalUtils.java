...
public class DigitalUtils {
    private static final String url = "backend/src/main/java/backend/backend/helpers/utils/digitalSignature/keys/";
    private static final String STORE_TYPE = "PKCS12";
    private static final char[] PASSWORD = "changeit".toCharArray();
    private static final String SENDER_KEYSTORE = url + "sender_keystore.p12";
    private static final String SENDER_ALIAS = "senderKeyPair";

    public static final String SIGNING_ALGORITHM = "SHA256withRSA";

    private static final String RECEIVER_KEYSTORE = url +"receiver_keystore.p12";
