...
public class GHNItem {
    ...
    public GHNItem(int payment_type_id, int weight, int length, int width, int height, int pick_station_id,
            int to_district_id, int insurance_value, int service_id, int service_type_id, int coupon, String note,
            String required_note, String return_phone, String return_address, String return_district_id,
            String return_ward_code, String client_order_code, String to_name, String to_phone, String to_address,
            String to_ward_code, String cod_amount, String content, List<Integer> pick_shift, List<GHNItem> items) {
