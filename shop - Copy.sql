...
INSERT INTO Product
VALUES(1, N'Mũ Nón Miki Kiểu Thủy Thủ Không Vành Loại D', 100, 1, 51.900, '');
INSERT INTO Product
VALUES(1, N'Mũ Nón Miki Kiểu Thủy Thủ Không Vành Loại C', 100, 1, 61.900, '');
INSERT INTO Product
VALUES(1, N'Mũ Nón Miki Kiểu Thủy Thủ Không Vành Loại B', 100, 1, 71.900, '');
INSERT INTO Product
VALUES(1, N'Mũ Nón Miki Kiểu Thủy Thủ Không Vành Loại A', 100, 1, 81.900, '');

--Single_Product_Page=2
INSERT INTO Product
VALUES(2, N'nón Beanie Loại D', 100, 1, 52.900, '');
INSERT INTO Product
VALUES(2, N'nón Beanie Loại C', 100, 1, 62.900, '');
INSERT INTO Product
VALUES(2, N'nón Beanie Loại B', 100, 1, 72.900, '');
INSERT INTO Product
VALUES(2, N'Mũ nón Beanie Loại A', 100, 1, 82.900, '');

--Single_Product_Page=3
INSERT INTO Product
VALUES(3, N'Mũ Nón Miki Loại D', 100, 1, 53.900, '');
INSERT INTO Product
VALUES(3, N'Mũ Nón Miki Loại C', 100, 1, 63.900, '');
INSERT INTO Product
VALUES(3, N'Mũ Nón Miki Loại B', 100, 1, 73.900, '');
INSERT INTO Product
VALUES(3, N'Mũ Nón Miki Loại A', 100, 1, 83.900, '');

--Single_Product_Page=4
INSERT INTO Product
VALUES(4, N'Mũ thủy thủ không vành Loại D', 100, 1, 54.900, '');
INSERT INTO Product
VALUES(4, N'Mũ thủy thủ không vành Loại C', 100, 1, 64.900, '');
INSERT INTO Product
VALUES(4, N'Mũ thủy thủ không vành Loại B', 100, 1, 74.900, '');
INSERT INTO Product
VALUES(4, N'Mũ thủy thủ không vành Loại A', 100, 1, 84.900, '');

--Single_Product_Page=5
INSERT INTO Product
VALUES(5, N'Áo khoác nữ Loại D', 100, 1, 55.900, '');
INSERT INTO Product
VALUES(5, N'Áo khoác nữ Loại C', 100, 1, 65.900, '');
INSERT INTO Product
VALUES(5, N'Áo khoác nữ Loại B', 100, 1, 75.900, '');
INSERT INTO Product
VALUES(5, N'Áo khoác nữ Loại A', 100, 1, 85.900, '');

INSERT INTO Product
VALUES(6, N'Mũ Nón Miki Kiểu Thủy Thủ Không Vành Loại D', 100, 1, 106.900, '');

--Single_Product_Page=7
INSERT INTO Product
VALUES(7, N'Ống Kính - Ống Ngắm Loại D', 100, 1, 67.900, '');
INSERT INTO Product
VALUES(7, N'Ống Kính - Ống Ngắm Loại C', 100, 1, 77.900, '');
INSERT INTO Product
VALUES(7, N'Ống Kính - Ống Ngắm Loại B', 100, 1, 87.900, '');
INSERT INTO Product
VALUES(7, N'Ống Kính - Ống Ngắm Loại A', 100, 1, 107.900, '');

INSERT INTO Product
VALUES(8, N'Cá, thuỷ hải sản', 100, 1, 100.900, '');
INSERT INTO Product
VALUES(9, N'Combo 2 hộp chia ngăn sắp xếp quần áo phong cách Nhật Bản VINAVU - Có Nắp - Kem Trơn', 100, 1, 850000.900, '');
INSERT INTO Product
VALUES(10, N'Áo thun hình gấu teddy cho chó mèo ( một cái, màu giao ngẫu nhiên ) - XXL', 100, 1, 1850000.900, '');
INSERT INTO Product
VALUES(11, N'Bộ bàn ăn mặt đá ceramic bóng kết hợp ghế Nelson - Bàn 1m4 + 4 ghế', 100, 1, 550000.900, '');
INSERT INTO Product
VALUES(12, N'Hộp vải đựng quần áo SETHOME đa năng giỏ đựng đồ lót sách vở đồ cá nhân thùng đựng mỹ phẩm cao cấp dễ dang gấp gọn - Chữ nhật - Be', 100, 1, 750000.900, '');
INSERT INTO Product
VALUES(13, N'Bộ bàn ăn mặt mặt đá cẩm thạch nhân tạo kết hợp 4 ghế 6 ghế 8 ghế Nelson - Bàn 1m4 + 4 ghế - Ghế màu trắng ghi', 100, 1, 350000.900, '');
INSERT INTO Product
VALUES(14, N'Mũ đi biển vành tròn gắn tag chư M nón móc len sợi rộng vành đi chơi siêu đẹp dành cho nữ.', 100, 1, 1250000.900, '');
INSERT INTO Product
VALUES(15, N'Nón Beanie vành tròn ️ Mũ tròn phong cách Retro Hàn Quốc form Unisex nam nữ N04', 100, 1, 1150000.900, '');
INSERT INTO Product
VALUES(16, N'Mũ tròn Miki màu trơn phong cách cổ điển độc đáo – thêu chữ kiểu dáng đơn giản', 100, 1, 750000.900, '');
INSERT INTO Product
VALUES(17, N'Mũ nón bucket nam nữ trơn tròn vành nhiều màu siêu đẹp MN20', 100, 1, 950000.900, '');
INSERT INTO Product
VALUES(18, N'Điện thoại Samsung Galaxy S22 Ultra 5G (12GB/512GB) - Hàng Chính Hãng', 100, 1, 550000.900, '');
INSERT INTO Product
VALUES(19, N'Tã Quần Huggies Dry Tràm Trà Tự Nhiên Gói Cực Đại XL62/XXL56 + Tặng 6 miếng', 100, 1, 500000.900, '');
INSERT INTO Product
VALUES(20, N'Combo 2 TúI Nước Giặt Omo Matic Cho Máy Giặt Cửa Trước Bền Đẹp Bền Màu Sau 100 Lần Giặt 3.6Kg', 100, 1, 670000.900, '');

--Single_Product_Page=21
INSERT INTO Product
VALUES(21, N'Apple iPhone 11 màu xanh', 100, 1, 1210000, '');
INSERT INTO Product
VALUES(21, N'Apple iPhone 11 màu đỏ', 100, 1, 1220000, '');
INSERT INTO Product
VALUES(21, N'Apple iPhone 11 màu vàng', 100, 1, 1230000, '');
INSERT INTO Product
VALUES(21, N'Apple iPhone 11 màu hồng', 100, 1, 1240000, '');
